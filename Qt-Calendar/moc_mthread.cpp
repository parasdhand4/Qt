...
#include "../Desktop/Qt-Calendar/mthread.h"
...
QT_MOC_LITERAL(1, 8, 10), // "AlarmFired"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "mThread\0AlarmFired\0"
};
...
void mThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mThread::AlarmFired)) {
                *result = 0;
                return;
            }
        }
